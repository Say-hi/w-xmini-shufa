 ...
 * @Last Modified time: 2020-03-20 12:25:32
 */
...
var serviceUrl = {
  ...
  codeInvite: lqsyBaseDomain + '104,248,212,208,218,204,242,104,208,232,210,212,100,220,230,246,220,242,212', // rank
  ...
  orderListOperate: lqsyBaseDomain + '104,240,218,232,234,104,232,238,210,212,238,100,226,220,240,242,100,232,234,212,238,204,242,212', // 订单详情单一产品收货api
  ...
  checkPrivier: lqsyTestDomain + '104,226,236,240,252,104,208,218,212,208,224,170,238,220,246,220,212,238,102,222,240,232,230',
  payShop: lqsyBaseDomain + '104,234,204,252,104,240,218,232,234', // 商城购买产品
  dictionaryCategory: lqsyBaseDomain + '104,210,220,208,242,220,232,230,204,238,252,104,208,204,242,212,216,232,238,252', // 碑帖评论点赞或者取消点赞
  dictionarySearch: lqsyBaseDomain + '104,210,220,208,242,220,232,230,204,238,252,104,240,212,204,238,208,218', // 碑帖评论点赞或者取消点赞
  ...
  commonUpload: lqsyBaseDomain + '104,208,232,228,228,232,230,104,244,234,226,232,204,210', // 用户申请退款
  commonImg: lqsyBaseDomain + '104,208,232,228,228,232,230,104,220,228,216', // 碑帖评论点赞或者取消点赞
  ...
  baseImageInfo: lqsyTestDomain + '104,226,236,240,252,104,206,204,240,212,156,228,204,216,212,156,230,214,232,102,222,240,232,230', // 修改购物车的数量2
  shopDiscussSub: lqsyBaseDomain + '104,240,218,232,234,104,210,220,240,208,244,240,240,100,240,244,206', // 用户提交商品评价
  userBind: lqsyBaseDomain + '104,244,240,212,238,104,206,220,230,210', // 获取用户基本信息
  ...
  sellProductDetail: lqsyBaseDomain + '104,240,212,226,226,104,234,238,232,210,244,208,242,100,210,212,242,220,204,226', // 获取商城头部广告
  ...
  tts: '218,242,242,234,240,126,104,104,242,240,230,102,206,204,220,210,244,102,208,232,228,104,242,212,250,242,110,204,244,210,220,232',
